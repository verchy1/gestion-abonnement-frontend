...
const DashboardContent = ({ stats, abonnements, isLoadingData }: { stats: Stats; abonnements: Abonnement[]; isLoadingData: boolean }) => {
  ...
  const statsCards = [
    ...
    },
    {
      ...
      iconBg: 'bg-linear-to-br from-emerald-100 to-teal-100',
    ...
    },
    {
      ...
      iconBg: 'bg-linear-to-br from-purple-100 to-violet-100',
    ...
    },
    {
      ...
      iconBg: 'bg-linear-to-br from-rose-100 to-pink-100',
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden bg-linear-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-3xl shadow-2xl p-8">
        ...
        {statsCards.map((stat, index) => {
          ...
          return (
            ...
            >
              ...
              <div className={`h-1.5 bg-linear-to-r ${stat.gradient} group-hover:h-2 transition-all duration-300`}></div>
              
              {/* Glow effect on hover */}
              <div className={`absolute inset-0 bg-linear-to-r ${stat.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500`}></div>
              ...
              <div className="relative p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className={`relative p-4 rounded-2xl ${stat.iconBg} group-hover:scale-110 transition-transform duration-300`}>
                    <div className={`absolute inset-0 bg-linear-to-r ${stat.gradient} opacity-0 group-hover:opacity-20 rounded-2xl transition-opacity duration-300`}></div>
      ...
      {stats.paiementsEnAttente > 0 && (
        <div className="relative overflow-hidden bg-linear-to-r from-amber-50 via-orange-50 to-yellow-50 border-l-4 border-amber-400 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
          <div className="absolute top-0 right-0 w-32 h-32 bg-amber-200/20 rounded-full -mr-16 -mt-16 blur-2xl"></div>
          <div className="relative p-6">
            <div className="flex items-start space-x-4">
              <div className="shrink-0 p-3 bg-amber-100 rounded-xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="relative group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden">
          ...
          <div className="relative p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-linear-to-br from-blue-100 to-indigo-100 rounded-xl group-hover:scale-110 transition-transform duration-300">
        ...
        {/* Taux d'occupation */}
        <div className="relative group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden">
          <div className="absolute inset-0 bg-linear-to-br from-green-500/5 to-emerald-500/5 group-hover:from-green-500/10 group-hover:to-emerald-500/10 transition-all duration-500"></div>
          <div className="relative p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-linear-to-br from-green-100 to-emerald-100 rounded-xl group-hover:scale-110 transition-transform duration-300">
        ...
        {/* Performance Badge */}
        <div className="relative group bg-linear-to-br from-purple-600 via-violet-600 to-indigo-600 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden">
