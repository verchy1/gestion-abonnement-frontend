              ...
              <tbody className="divide-y divide-gray-200">
                {utilisateurs.map(user => (
                  <tr key={user._id} className="hover:bg-gray-50 transition duration-150">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{formatDate(user.dateFin)}</td>
            ...
            {utilisateurs.map(user => (
              <div key={user._id} className="p-4 hover:bg-gray-50">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between"><span className="text-gray-600">Expiration:</span><span className="font-medium text-gray-900">{formatDate(user.dateFin)}</span></div>
