...
import { Plus, Trash2, CreditCard, Link2, Calendar, TrendingUp, Wallet } from 'lucide-react';
...
const CartesContent: FC<Props> = ({ cartes = [], setShowModal, supprimerCarte, loading, onLinkClick }) => {
      ...
      {cartes.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {cartes.map(c => {
            ...
            // narrow type to avoid using `any`
